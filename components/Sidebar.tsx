...
export default function Sidebar() {
  ...
  return (
    <aside className="col-12 col-md-3 col-xl-2 p-0  sticky-top bg-secondary">
      <nav
        className="navbar navbar-expand-md navbar-dark bg-secondary flex-md-column flex-sm-row d-flex  align-items-center flex-row p-0  sticky-top"
        id="sidebar"
      >
        <div className="text-center  p-lg-3 p-2 px-3 d-flex flex-column align-items-center blur-5">
          <Link
            href="/"
        ...
        >
          ...
          <ul className="navbar-nav flex-column w-100 px-2 px-lg-0">
            ...
            <li
              className={`nav-item bg-${
                ...
                (active.asPath.includes(CHARACTER_ROUTE) &&
          ...
          <div className=" w-100 mx-1 mt-4 ">
            ...
            <div className="dropdown d-flex justify-content-between order-1 dropup px-lg-2 px-2 gap-2 align-items-center my-1">
              ...
              >
                {theme === 'light' ? (
                  <BsFillMoonStarsFill fontSize={16} color="white" />
                ) : (
                  <BsSun fontSize={16} color="white" />
                )}
              </button>
            </div>
          </div>
